...
{
//    $cinemas = get_cinemas_that_show_film($id);
    $film = get_film_full_info($id);
    ?>
    <div rid="<?php echo $id ?>" class="content">
        <a id="sync" class="btn btn-mini" style="float: left">
...
<!--                <td>-->
<!--                    <div class="toggletop"-->
<!--                         onclick="$(this).next().slideToggle(function(){$(this).parent().find('.cinema_header i').toggle();});">-->
